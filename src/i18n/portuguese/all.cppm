...
export namespace i18n{
	...
	inline constexpr wchar_t ENVIRONMENT_VARIABLES[]         = L"\u2618 Vari\U000000E1veis de ambiente:";
	inline constexpr wchar_t ENVIRONMENT_VARIABLES_WARNING[] = L"\u26A0 Aten\U000000E7\U000000E3o: verifique se "
	...
	inline constexpr wchar_t HOUR[]                 = L"hora";
	inline constexpr wchar_t HOURS[]                = L"horas";
	inline constexpr wchar_t SYSTEM_CLOCK[]         = L"\u25D0 Rel\U000000F3gio do sistema:";
	...
	inline constexpr wchar_t BATTERY_DAY[]              = L"dia";
	inline constexpr wchar_t BATTERY_DAYS[]             = L"dias";
	inline constexpr wchar_t BATTERY_HOUR[]             = L"hora";
	inline constexpr wchar_t BATTERY_HOURS[]            = L"horas";
	inline constexpr wchar_t BATTERY_MINUTE[]           = L"minuto";
...
// src/core/$(SYSTEM)/cpu.cpp
	...
	inline constexpr wchar_t CPU[]                    = L"\u2699 Processador:";
#endif

// src/core/$(SYSTEM)/features.cpp
#if defined(ENABLE_FEATURES)
	inline constexpr wchar_t FEATURES[] = L"\u25A3 Recursos:";
#endif
...
// src/core/$(SYSTEM)/hard_disks.cpp
	...
	inline constexpr wchar_t HARD_DISKS[] = L"\u25A4 Discos r\U000000EDgidos:";
...
// src/core/$(SYSTEM)/installed.cpp
	...
	inline constexpr wchar_t INSTALLED_PROGRAMS[] = L"\u25B2 Programas instalados:";
#endif
...
// src/core/$(SYSTEM)/memory.cpp
	...
	inline constexpr wchar_t MEMORY[]              = L"\u25A6 Mem\U000000F3ria (RAM):";
...
// src/core/$(SYSTEM)/network.cpp
	...
	inline constexpr wchar_t NETWORK[]       = L"\u25A7 Rede:";
...
// src/core/$(SYSTEM)/operating_system.cpp
	...
	inline constexpr wchar_t OPERATING_SYSTEM[] = L"\u25CF Sistema operacional:";
...
// src/core/$(SYSTEM)/processes.cpp
	...
	inline constexpr wchar_t RUNNING_PROCESSES[] = L"\u25D0 Processos:";
	inline constexpr wchar_t TOTAL_PROCESSES[]   = L"Total:";
#endif

// src/core/$(SYSTEM)/restore.cpp
#if defined(ENABLE_RESTORE)
	inline constexpr wchar_t RESTORE_POINT[]     = L"\u25CB Ponto de restaura\U000000E7\U000000E3o:";
	inline constexpr wchar_t RESTORE_POINTS[]    = L"\u25CB Pontos de restaura\U000000E7\U000000E3o:";
...
// src/core/$(SYSTEM)/services.cpp
	...
	inline constexpr wchar_t SERVICES[] = L"\u25C6 Servi\U000000E7os:";
#endif

// src/core/$(SYSTEM)/shared.cpp
#if defined(ENABLE_SHARED)
	inline constexpr wchar_t SHARED[]       = L"\u25CF Compartilhado:";
	inline constexpr wchar_t SHARED_EMPTY[] = L"\U0000274C Nenhum recurso compartilhado";
#endif

// src/core/$(SYSTEM)/startup.cpp
#if defined(ENABLE_STARTUP)
	inline constexpr wchar_t STARTUP[] = L"\u221A Programas executados na inicializa\U000000E7\U000000E3o:";
#endif

// src/core/windows/trash.cpp
#if defined(ENABLE_TRASH)
	inline constexpr wchar_t TRASH[]       = L"\u25B2 Lixeira:";
	inline constexpr wchar_t TRASH_EMPTY[] = L"\U00002705 Lixeira vazia";
#endif

// src/core/$(SYSTEM)/usb.cpp
#if defined(ENABLE_USB)
	inline constexpr wchar_t USB[]       = L"\u25CF Dispositivos USB:";
	inline constexpr wchar_t USB_EMPTY[] = L"\U0000274C Nenhum dispositivo USB encontrado";
#endif
